...
const EXPENSE_CATS   = ["🏠 Loyer","🚗 Transport","🛒 Courses","🍽️ Restaurant","📱 Abonnements","⚡ Énergie","💊 Santé","🧾 Impôt","📞 Téléphone","🌐 Internet","🏦 Crédit immobilier","🛠️ Crédit travaux","🛡️ Assurance","👶 Enfant","⚽ Sport","🚨 Amende","💳 Frais bancaires","🔧 Divers"];
...
export default function Home() {
  ...
  const proC=useMemo(()=>{
    ...
    const benefice=totalEntrees/1.2-frais-salaire-per-chargesPay;
